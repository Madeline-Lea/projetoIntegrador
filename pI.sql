...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14-Dez-2021 às 01:15
...
('root', '[{\"db\":\"pi\",\"table\":\"usuarios\"},{\"db\":\"pi\",\"table\":\"perguntas\"}]');
...
('root', '2021-12-14 00:04:32', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\",\"ThemeDefault\":\"darkwolf\"}');
...
CREATE TABLE `respostas` (
  ...
  `pergunta_id` int(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `usuarios` (
  ...
  `genero` enum('M','F','T','I') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
